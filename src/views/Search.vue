        ...
        <div class="hot-search">
            ...
            <div class="img">
                <router-link to="/goodsdetail?id=0012">
                    <img src="https://res.vmallres.com/pimages/recommendmsg/2018102703418474.png" alt="">
                </router-link>
            </div>
        </div>
        <div class="hot-item" v-show="searchList.length == 0">
            <ul class="item-list">
                <li class="item"><router-link to="/goodsdetail?id=0013">HUAWEI nova 2s</router-link></li>
                <li class="item"><router-link to="/goodsdetail?id=0011">华为畅享平板</router-link></li>
                <li class="item"><router-link to="/goodsdetail?id=0008">荣耀手环4</router-link></li>
                <li class="item"><router-link to="/goodsdetail?id=0007">荣耀路由 X2</router-link></li>
            </ul>
        </div>
